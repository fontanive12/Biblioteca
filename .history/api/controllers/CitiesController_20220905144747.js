...
class CitiesController {
  ...
  _validateData = async (data, id) => {
    ...
    if (await this._checkIfEmailExists(city.states_id, id)) {
      throw new Error(`The city with mail address "${city.states_id}" already exists.`);
    }

    return city;
  }

  _checkIfEmailExists = async (states_id, id) => {
    const where = {
        states_id: states_id
    };
