        ...
        .then((response) => {
            if (response.status === 200) {
                ...
                data.forEach(element => {
                    ...
                    trHTML += '<td><button type="button" class="btn btn-outline-secondary" onclick="showStateEditEditBox(' + element.id + ')"><img src="/images/iconEdit.png"></button>';
                    trHTML += '<button type="button" class="btn btn-outline-danger" onclick="stateDelete(' + element.id + ')"><img src="/images/iconDelete.png"></button></td>';
                    trHTML += "</tr>";
                });
